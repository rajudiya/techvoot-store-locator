...
namespace Techvoot\StoreLocator\Block\Adminhtml\Retailer\SpecialOpeningHours\Container;
...
use Techvoot\StoreLocator\Block\Adminhtml\Retailer\OpeningHours\Element\Renderer as ElementRenderer;
...
class Renderer extends AbstractFieldArray
{
    ...
    private function renderDateColumn(string $columnName): string
    {
        ...
        $element->setFormat($this->_localeDate->getDateFormatWithLongYear())
            ...
            ->addClass("techvoot-special-opening-hours-datepicker");
