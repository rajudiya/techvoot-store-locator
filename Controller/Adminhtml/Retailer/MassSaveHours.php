...
namespace Techvoot\StoreLocator\Controller\Adminhtml\Retailer;
...
use Techvoot\Retailer\Api\Data\RetailerInterfaceFactory;
use Techvoot\Retailer\Api\RetailerRepositoryInterface;
use Techvoot\Retailer\Controller\Adminhtml\AbstractRetailer;
use Techvoot\Retailer\Model\ResourceModel\Retailer\CollectionFactory;
use Techvoot\StoreLocator\Model\Retailer\OpeningHoursPostDataHandler;
use Techvoot\StoreLocator\Model\Retailer\SpecialOpeningHoursPostDataHandler;
...
class MassSaveHours extends AbstractRetailer implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        return $resultRedirect->setPath('techvoot_retailer/retailer/');
    }
}
